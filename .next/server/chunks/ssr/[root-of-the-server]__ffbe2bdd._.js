...
"[project]/.next-internal/server/app/review/page/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET(req) {
    try {
        ...
        const auth = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$googleapis$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["google"].auth.GoogleAuth({
            keyFile: __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'google-credentials.json'),
            scopes: [
        ...
        const filtered = rows.map((row, idx)=>({
                rowIndex: idx,
                OriginalQuery: row[0] || '',
                Prompt: row[1] || '',
                ModifiedQuery: row[2] || '',
                ...
                BankName: row[7] || '',
                Segment: row[8] || ''
            })).filter((item)=>(!bank || item.BankName === bank) && (!segment || item.Segment === segment));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NextResponse"].json(filtered);
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffbe2bdd._.js.map